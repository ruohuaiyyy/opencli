...
import { parseArticlesPage, parseToutiaoArticlesText, looksToutiaoAuthWallText } from './utils.js';
...
cli({
  ...
  func: async (page: IPage | null, kwargs) => {
    ...
    try {
      ...
      throw new CommandExecutionError(`toutiao articles render failed: ${msg}`);
    }
